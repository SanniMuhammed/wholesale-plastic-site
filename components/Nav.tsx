    ...
    <span className="group/logo inline-flex shrink-0 items-center gap-2.5" aria-hidden>
      <span className="relative flex h-10 w-10 shrink-0 items-center justify-center sm:h-11 sm:w-11">
        <svg viewBox="0 0 48 48" className="h-full w-full" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M12 6.5h24a4 4 0 0 1 4 4v3H8v-3a4 4 0 0 1 4-4Z" className="fill-accent" />
          <path d="M31.8 17.5c-2-1.45-4.55-2.15-7.55-2.15-5.1 0-8.1 2.05-8.1 5.25 0 3.05 2.55 4.2 7.65 5.15 4.4.8 6.15 1.65 6.15 3.65 0 2.2-2.2 3.6-5.9 3.6-3.15 0-5.9-.9-7.95-2.55" className="stroke-brand transition-transform duration-300 group-hover/logo:translate-x-0.5" strokeWidth="3.1" strokeLinecap="round" />
...
export function Nav({ locale, dict }: NavProps) {
  ...
  return (
    <header className={cx("sticky top-0 z-40 border-b bg-brand text-surface backdrop-blur transition-shadow duration-300", scrolled ? "border-brand-dark shadow-card" : "border-brand/70")}>
      <div className="mx-auto flex h-16 w-full max-w-content items-center gap-2 px-4 sm:h-[68px] sm:gap-3 lg:gap-4 lg:px-8">
