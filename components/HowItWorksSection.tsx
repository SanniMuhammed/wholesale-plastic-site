  ...
  return (
    <section id={id} className="border-y border-border bg-surface scroll-mt-20">
      <div className="mx-auto max-w-content px-4 py-14 sm:px-6 sm:py-20">
        ...
        {imageUrl && <picture className="mt-8 block overflow-hidden rounded-xl border border-border bg-background">{mobileImageUrl && <source media="(max-width: 640px)" srcSet={mobileImageUrl} />}<img src={imageUrl} alt="" className="h-auto max-h-[420px] w-full object-cover" loading="lazy" /></picture>}
        <div ref={ref}>
