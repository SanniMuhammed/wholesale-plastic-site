...
const BUSINESS_TYPES = [
  {
    en: {
      title: "For Resellers",
      description: "Stock fast-moving plastic products for your shop or market stall.",
    },
    fr: {
      title: "Pour les revendeurs",
      description: "Approvisionnez votre boutique ou votre étal en produits plastiques demandés.",
    },
    category: "household",
  },
  {
    en: {
      ...
      description: "Source bowls, containers and everyday plastic supplies in bulk.",
    },
    fr: {
      title: "Pour les restaurants",
      description: "Approvisionnez-vous en bols, récipients et articles plastiques en gros.",
    },
    category: "containers",
  },
  {
    en: {
      ...
      description: "Build a dependable supply of practical household plastic products.",
    },
    fr: {
      title: "Pour les hôtels et l'hôtellerie",
      description: "Constituez un stock fiable de produits plastiques pratiques pour l'accueil.",
    },
    category: "household",
  },
  {
    en: {
      ...
      description: "Start sourcing from Nigeria without needing to travel there yourself.",
    },
    fr: {
      title: "Démarrer un commerce",
      description: "Commencez à vous approvisionner au Nigeria sans avoir à vous y déplacer.",
    },
    category: "buckets",
  },
];
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  <span className="text-lg text-ink-soft transition-transform group-hover:translate-x-1" aria-hidden>
                    →
                  </span>
                </div>
