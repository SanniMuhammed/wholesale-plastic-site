  ...
  return (
    <div className="mt-7 flex flex-col gap-4">
      <div className="rounded-xl border border-border bg-surface p-4 sm:p-5">
        ...
        <Link href={`/${locale}/order-summary`} className="mt-3 inline-flex w-full items-center justify-center rounded border border-border bg-brand px-4 py-2.5 text-xs font-semibold text-surface transition-colors hover:bg-brand-dark">{dict.common.reviewOrder} →</Link>
      </div>
