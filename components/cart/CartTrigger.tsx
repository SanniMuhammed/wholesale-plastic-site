    ...
    return (
      ...
      >
        ...
        <span
          data-cart-badge
          className={cx(
            "absolute -right-1.5 -top-1.5 inline-flex h-5 min-w-[1.25rem] items-center justify-center rounded-full border border-brand bg-white px-1 font-mono text-xs font-bold text-brand transition-opacity",
            count === 0 && "opacity-0"
          )}
        >
          {count}
