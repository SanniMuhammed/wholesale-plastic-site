        ...
        {featured.map((category, i) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={cx(
                  "absolute left-5 top-4 font-mono text-xs font-bold",
                  photoUrl ? "text-white/80" : "text-ink-soft/60"
                )}
              >
              ...
              <span className={cx("relative font-display text-xl font-semibold", photoUrl ? "text-white" : "text-ink")}>
