...
export function Footer({ locale, dict }: { locale: Locale; dict: Dictionary }) {
  ...
  const mission = locale === "fr"
    ? "Nous rapprochons les produits et les opportunités du Nigeria des entreprises qui les font grandir en Afrique de l’Ouest."
    : "We connect Nigerian products and opportunity with the businesses building what’s next across West Africa.";
      ...
      <div className="mx-auto max-w-content px-4 py-16 sm:px-6 sm:py-20">
        ...
        <div className="mt-14 grid gap-12 border-t border-border pt-10 sm:mt-16 sm:grid-cols-[1.5fr_1fr_0.7fr] sm:gap-10 sm:pt-12">
          <div>
            ...
            <ul className="mt-5 space-y-2 font-display text-base text-ink-soft">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 font-display text-base text-ink-soft">
          ...
          <div className="sm:mt-8 sm:text-right">
        ...
        <div className="mt-14 flex flex-col gap-5 border-t border-border pt-7 sm:mt-16 sm:flex-row sm:items-center sm:justify-between">
          <p className="font-mono text-xs tracking-wide text-muted">{interpolate(dict.footer.copyright, { year })}</p>
          <div className="inline-flex self-start rounded-full border border-border bg-background p-1 sm:self-auto">
