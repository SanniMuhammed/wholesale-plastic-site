  ...
  return (
    <footer className="border-t border-border bg-surface print:hidden">
      <div className="mx-auto max-w-content px-4 py-12 sm:px-6 sm:py-16">
        ...
        <div className="mt-10 grid grid-cols-2 gap-x-8 gap-y-9 border-t border-border pt-8 sm:mt-14 sm:grid-cols-[1.5fr_1fr_0.7fr] sm:gap-10 sm:pt-12">
          <div>
          ...
          <div className="col-span-2 sm:col-span-1 sm:mt-8 sm:text-right">
            <h3 className="eyebrow">{dict.footer.companyHeading}</h3>
            <ul className="mt-4 space-y-2 font-display text-base text-ink-soft sm:flex sm:justify-end sm:gap-6 sm:space-y-0">
