      ...
      <div className={`relative z-10 flex items-center ${hasHeroImage ? "min-h-[460px] sm:min-h-[490px] md:min-h-[510px] lg:min-h-[540px]" : ""}`}>
        <div className={`${hasHeroImage ? "w-full max-w-[34rem] sm:w-[76%] sm:max-w-[36rem] md:w-[68%] lg:w-[64%] xl:w-[62%]" : "w-full md:max-w-2xl"}`}>
          <div className="animate-settle-up">
            <p className="eyebrow inline-flex max-w-full -rotate-1 items-center rounded border border-brand/20 bg-brand-light/90 px-3 py-1.5 text-brand shadow-sm backdrop-blur-md">
              {dict.hero.supporting}
            </p>

            <h1 className="mt-5 max-w-[22ch] font-display text-[clamp(2.65rem,7.6vw,4.75rem)] font-semibold leading-[0.94] tracking-[-0.04em] text-ink [text-wrap:balance] sm:mt-6 sm:max-w-[24ch] sm:text-[clamp(3rem,6.8vw,5.25rem)] sm:leading-[0.91] lg:text-[4.75rem]">
              {dict.hero.title}
            </h1>
